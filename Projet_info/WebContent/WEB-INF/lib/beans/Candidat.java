...
public class Candidat implements Serializable, Comparable<Candidat> {
    ...
    private GregorianCalendar dateCandidature;
	...
	public Candidat(int numeroCandidat, String nom, String prenom,
			...
			String login, String password, GregorianCalendar dateCandidature,
	...
	/**
	 * @return the dateCandidature
	 */
	public GregorianCalendar getDateCandidature() {
		return dateCandidature;
	}

	/**
	 * @param dateCandidature the dateCandidature to set
	 */
	public void setDateCandidature(GregorianCalendar dateCandidature) {
		this.dateCandidature = dateCandidature;
	}
	...
	/**
	 * @param mesPostulations the mesPostulations to set
	 */
	...
	public int compareTo(Candidat o) {
		return this.getNumeroCandidat()-o.getNumeroCandidat();
